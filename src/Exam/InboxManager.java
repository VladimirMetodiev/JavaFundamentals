...
public class InboxManager {
    public static void main(String[] args) {
        ...
        while(!(expression = input.nextLine()).equals("Statistics")){
        ...
        users
                .entrySet()
                .stream()
                .sorted(Map.Entry.<String, ArrayList<String>>comparingByValue(Comparator.comparing(ArrayList::size)).reversed().thenComparing(Map.Entry.comparingByKey()))
                .forEach(user ->{
